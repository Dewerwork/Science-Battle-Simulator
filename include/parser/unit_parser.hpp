...
inline const std::unordered_map<std::string, RuleId>& UnitParser::get_rule_map() {
    static const std::unordered_map<std::string, RuleId> map = {
        ...
        {"counter-attack", RuleId::CounterAttack},
        {"counterattack", RuleId::CounterAttack},
        {"counter attack", RuleId::CounterAttack},
        {"fast", RuleId::Fast},
        ...
        {"counter-attack aura", RuleId::CounterAttack},
        {"counterattack aura", RuleId::CounterAttack},
        {"counter attack aura", RuleId::CounterAttack},
        ...
        {"versatile reach aura", RuleId::VersatileReachAura},
        {"versatilereachaura", RuleId::VersatileReachAura},
        {"unpredictable fighter aura", RuleId::UnpredictableFighterAura},
        {"unpredictablefighteraura", RuleId::UnpredictableFighterAura},
        {"point-blank piercing aura", RuleId::PointBlankPiercingAura},
        {"pointblankpiercingaura", RuleId::PointBlankPiercingAura},
        {"ranged slayer aura", RuleId::RangedSlayerAura},
        {"rangedslayeraura", RuleId::RangedSlayerAura},
        {"targeting visor boost aura", RuleId::TargetingVisorBoostAura},
        {"targetingvisorboostaura", RuleId::TargetingVisorBoostAura},
        {"piercing hunter aura", RuleId::PiercingHunterAura},
        {"piercinghunteraura", RuleId::PiercingHunterAura},
        {"clan warrior boost aura", RuleId::ClanWarriorBoostAura},
        {"clanwarriorboostaura", RuleId::ClanWarriorBoostAura},
        {"precision fighter aura", RuleId::PrecisionFighterAura},
        {"precisionfighteraura", RuleId::PrecisionFighterAura},
        {"mischievous boost aura", RuleId::MischievousBoostAura},
        {"mischievousboostaura", RuleId::MischievousBoostAura},
        {"quick shot aura", RuleId::QuickShotAura},
        {"quickshotaura", RuleId::QuickShotAura},
        {"havocbound boost aura", RuleId::HavocboundBoostAura},
        {"havocboundboostaura", RuleId::HavocboundBoostAura},
        {"warbound boost aura", RuleId::WarboundBoostAura},
        {"warboundboostaura", RuleId::WarboundBoostAura},
        {"infected boost aura", RuleId::InfectedBoostAura},
        {"infectedboostaura", RuleId::InfectedBoostAura},
        {"unpredictable shooter aura", RuleId::UnpredictableShooterAura},
        {"unpredictableshooteraura", RuleId::UnpredictableShooterAura},
        {"scrapper boost aura", RuleId::ScrapperBoostAura},
        {"scrapperboostaura", RuleId::ScrapperBoostAura},
        {"ferocious boost aura", RuleId::FerociousBoostAura},
        {"ferociousboostaura", RuleId::FerociousBoostAura},
        {"piercing fighter aura", RuleId::PiercingFighterAura},
        {"piercingfighteraura", RuleId::PiercingFighterAura},
        {"precision charge aura", RuleId::PrecisionChargeAura},
        {"precisionchargeaura", RuleId::PrecisionChargeAura},
        {"grounded precision aura", RuleId::GroundedPrecisionAura},
        {"groundedprecisionaura", RuleId::GroundedPrecisionAura},
        {"melee slayer aura", RuleId::MeleeSlayerAura},
        {"meleeslayeraura", RuleId::MeleeSlayerAura},
        {"piercing shooter aura", RuleId::PiercingShooterAura},
        {"piercingshooteraura", RuleId::PiercingShooterAura},

        // === Category J: Buff Rules ===
        {"righteous fury", RuleId::RighteousFury},
        {"righteousfury", RuleId::RighteousFury},
        {"precision fighter buff", RuleId::PrecisionFighterBuff},
        {"precisionfighterbuff", RuleId::PrecisionFighterBuff},
        {"precision shooter buff", RuleId::PrecisionShooterBuff},
        {"precisionshooterbuff", RuleId::PrecisionShooterBuff},
        {"bane in melee buff", RuleId::BaneInMeleeBuff},
        {"baneinmeleebuff", RuleId::BaneInMeleeBuff},
        {"primal boost buff", RuleId::PrimalBoostBuff},
        {"primalboostbuff", RuleId::PrimalBoostBuff},
        {"precision attacks buff", RuleId::PrecisionAttacksBuff},
        {"precisionattacksbuff", RuleId::PrecisionAttacksBuff},

        // === Category K: Mark Rules ===
        {"unpredictable fighter mark", RuleId::UnpredictableFighterMark},
        {"unpredictablefightermark", RuleId::UnpredictableFighterMark},
        {"unstoppable shooting mark", RuleId::UnstoppableShootingMark},
        {"unstoppableshootingmark", RuleId::UnstoppableShootingMark},
        {"shred mark", RuleId::ShredMark},
        {"shredmark", RuleId::ShredMark},
        {"piercing shooting mark", RuleId::PiercingShootingMark},
        {"piercingshootingmark", RuleId::PiercingShootingMark},
        {"precision fighting mark", RuleId::PrecisionFightingMark},
        {"precisionfightingmark", RuleId::PrecisionFightingMark},
        {"slayer mark", RuleId::SlayerMark},
        {"slayermark", RuleId::SlayerMark},
        {"relentless mark", RuleId::RelentlessMark},
        {"relentlessmark", RuleId::RelentlessMark},
        {"rending in melee mark", RuleId::RendingInMeleeMark},
        {"rendinginmeleemark", RuleId::RendingInMeleeMark},
        {"furious mark", RuleId::FuriousMark},
        {"furiousmark", RuleId::FuriousMark},
        {"indirect mark", RuleId::IndirectMark},
        {"indirectmark", RuleId::IndirectMark},
        {"bane mark", RuleId::BaneMark},
        {"banemark", RuleId::BaneMark},
        {"precision shooting mark", RuleId::PrecisionShootingMark},
        {"precisionshootingmark", RuleId::PrecisionShootingMark},
        {"quick shot mark", RuleId::QuickShotMark},
        {"quickshotmark", RuleId::QuickShotMark},

        // === Category L: Debuff Rules ===
        {"unwieldy debuff", RuleId::UnwieldyDebuff},
        {"unwieldydebuff", RuleId::UnwieldyDebuff},
        {"precision debuff", RuleId::PrecisionDebuff},
        {"precisiondebuff", RuleId::PrecisionDebuff},
        {"piercing shooting debuff", RuleId::PiercingShootingDebuff},
        {"piercingshootingdebuff", RuleId::PiercingShootingDebuff},

        // === Category M: Scaling/Frenzy/Growth Rules ===
        {"piercing growth", RuleId::PiercingGrowth},
        {"piercinggrowth", RuleId::PiercingGrowth},
        {"ruinous frenzy", RuleId::RuinousFrenzy},
        {"ruinousfrenzy", RuleId::RuinousFrenzy},
        {"devastating frenzy", RuleId::DevastatingFrenzy},
        {"devastatingfrenzy", RuleId::DevastatingFrenzy},
        {"precision growth", RuleId::PrecisionGrowth},
        {"precisiongrowth", RuleId::PrecisionGrowth},
        {"destructive frenzy", RuleId::DestructiveFrenzy},
        {"destructivefrenzy", RuleId::DestructiveFrenzy},

        // === Category N: Storm AoE Rules ===
        {"storm of change", RuleId::StormOfChange},
        {"stormofchange", RuleId::StormOfChange},
        {"storm of lust", RuleId::StormOfLust},
        {"stormoflust", RuleId::StormOfLust},
        {"storm of plague", RuleId::StormOfPlague},
        {"stormofplague", RuleId::StormOfPlague},
        {"storm of war", RuleId::StormOfWar},
        {"stormofwar", RuleId::StormOfWar},

        // === Category O: Special Combat Rules ===
        {"breath attack", RuleId::BreathAttack},
        {"breathattack", RuleId::BreathAttack},
        {"increased shooting range", RuleId::IncreasedShootingRange},
        {"increasedshootingrange", RuleId::IncreasedShootingRange},
        {"regenerative strength", RuleId::RegenerativeStrength},
        {"regenerativestrength", RuleId::RegenerativeStrength},
        {"strafing", RuleId::Strafing},
        {"surprise attack", RuleId::SurpriseAttack},
        {"surpriseattack", RuleId::SurpriseAttack},
        {"takedown strike", RuleId::TakedownStrike},
        {"takedownstrike", RuleId::TakedownStrike},
        {"instinctive", RuleId::Instinctive},
        {"crossing attack", RuleId::CrossingAttack},
        {"crossingattack", RuleId::CrossingAttack},
        {"quick readjustment", RuleId::QuickReadjustment},
        {"quickreadjustment", RuleId::QuickReadjustment},
        {"crossing strike", RuleId::CrossingStrike},
        {"crossingstrike", RuleId::CrossingStrike},
        {"surprise piercing shot", RuleId::SurprisePiercingShot},
        {"surprisepiercingshot", RuleId::SurprisePiercingShot},
        {"mind wound", RuleId::MindWound},
        {"mindwound", RuleId::MindWound},
        {"mobile artillery", RuleId::MobileArtillery},
        {"mobileartillery", RuleId::MobileArtillery},
        {"vengeance", RuleId::Vengeance},

        // === Category P: Activation Rules ===
        {"martial prowess", RuleId::MartialProwess},
        {"martialprowess", RuleId::MartialProwess},
        {"coordinate", RuleId::Coordinate},
        {"inquisitorial agent", RuleId::InquisitorialAgent},
        {"inquisitorialagent", RuleId::InquisitorialAgent},
        {"delayed action", RuleId::DelayedAction},
        {"delayedaction", RuleId::DelayedAction},

        // === Category Q: Remaining Boost Auras ===
        {"sturdy boost aura", RuleId::SturdyBoostAura},
        {"sturdyboostaura", RuleId::SturdyBoostAura},
        {"versatile defense aura", RuleId::VersatileDefenseAura},
        {"versatiledefenseaura", RuleId::VersatileDefenseAura},
        {"changebound boost aura", RuleId::ChangeboundBoostAura},
        {"changeboundboostaura", RuleId::ChangeboundBoostAura},
        {"plaguebound boost aura", RuleId::PlageboundBoostAura},
        {"plageboundboostaura", RuleId::PlageboundBoostAura},
        {"defensive growth aura", RuleId::DefensiveGrowthAura},
        {"defensivegrowthaura", RuleId::DefensiveGrowthAura},
        {"machine-fog boost aura", RuleId::MachineFogBoostAura},
        {"machinefogboostaura", RuleId::MachineFogBoostAura},
        {"reanimation aura", RuleId::ReanimationAura},
        {"reanimationaura", RuleId::ReanimationAura},
        {"grounded reinforcement aura", RuleId::GroundedReinforcementAura},
        {"groundedreinforcementaura", RuleId::GroundedReinforcementAura},
        {"devout boost aura", RuleId::DevoutBoostAura},
        {"devoutboostaura", RuleId::DevoutBoostAura},
        {"courage aura", RuleId::CourageAura},
        {"courageaura", RuleId::CourageAura},
        {"hold the line boost aura", RuleId::HoldTheLineBoostAura},
        {"holdthelineboostaura", RuleId::HoldTheLineBoostAura},
        {"rapid rush aura", RuleId::RapidRushAura},
        {"rapidrushaura", RuleId::RapidRushAura},
        {"harassing boost aura", RuleId::HarassingBoostAura},
        {"harassingboostaura", RuleId::HarassingBoostAura},
        {"swift aura", RuleId::SwiftAura},
        {"swiftaura", RuleId::SwiftAura},
        {"rapid blink boost aura", RuleId::RapidBlinkBoostAura},
        {"rapidblinkboostaura", RuleId::RapidBlinkBoostAura},
        {"rapid advance aura", RuleId::RapidAdvanceAura},
        {"rapidadvanceaura", RuleId::RapidAdvanceAura},
        {"lustbound boost aura", RuleId::LustboundBoostAura},
        {"lustboundboostaura", RuleId::LustboundBoostAura},
        {"bounding aura", RuleId::BoundingAura},
        {"boundingaura", RuleId::BoundingAura},
        {"highborn boost aura", RuleId::HighbornBoostAura},
        {"highbornboostaura", RuleId::HighbornBoostAura},
        {"speed feat aura", RuleId::SpeedFeatAura},
        {"speedfeataura", RuleId::SpeedFeatAura},
        {"scurry boost aura", RuleId::ScurryBoostAura},
        {"scurryboostaura", RuleId::ScurryBoostAura},
        {"guerrilla boost aura", RuleId::GuerrillaBoostAura},
        {"guerrillaboostaura", RuleId::GuerrillaBoostAura},

        // === Category R: Remaining Buffs ===
        {"stealth buff", RuleId::StealthBuff},
        {"stealthbuff", RuleId::StealthBuff},
        {"protective dome", RuleId::ProtectiveDome},
        {"protectivedome", RuleId::ProtectiveDome},
        {"guarded buff", RuleId::GuardedBuff},
        {"guardedbuff", RuleId::GuardedBuff},
        {"regeneration buff", RuleId::RegenerationBuff},
        {"regenerationbuff", RuleId::RegenerationBuff},
        {"entrenched buff", RuleId::EntrenchedBuff},
        {"entrenchedbuff", RuleId::EntrenchedBuff},
        {"self-repair boost buff", RuleId::SelfRepairBoostBuff},
        {"selfrepairboostbuff", RuleId::SelfRepairBoostBuff},
        {"courage buff", RuleId::CourageBuff},
        {"couragebuff", RuleId::CourageBuff},
        {"steadfast buff", RuleId::SteadfastBuff},
        {"steadfastbuff", RuleId::SteadfastBuff},
        {"no retreat buff", RuleId::NoRetreatBuff},
        {"noretreatbuff", RuleId::NoRetreatBuff},
        {"rapid advance buff", RuleId::RapidAdvanceBuff},
        {"rapidadvancebuff", RuleId::RapidAdvanceBuff},
        {"swift buff", RuleId::SwiftBuff},
        {"swiftbuff", RuleId::SwiftBuff},
        {"speed buff", RuleId::SpeedBuff},
        {"speedbuff", RuleId::SpeedBuff},
        {"increased shooting range mark", RuleId::IncreasedShootingRangeMark},
        {"increasedshootingrangemark", RuleId::IncreasedShootingRangeMark},
        {"extended buff range", RuleId::ExtendedBuffRange},
        {"extendedbuffrange", RuleId::ExtendedBuffRange},
        {"increased shooting range buff", RuleId::IncreasedShootingRangeBuff},
        {"increasedshootingrangebuff", RuleId::IncreasedShootingRangeBuff},
        {"casting buff", RuleId::CastingBuff},
        {"castingbuff", RuleId::CastingBuff},

        // === Category S: Remaining Debuffs ===
        {"fatigue debuff", RuleId::FatigueDebuff},
        {"fatiguedebuff", RuleId::FatigueDebuff},
        {"defense debuff", RuleId::DefenseDebuff},
        {"defensedebuff", RuleId::DefenseDebuff},
        {"morale debuff", RuleId::MoraleDebuff},
        {"moraledebuff", RuleId::MoraleDebuff},
        {"speed debuff", RuleId::SpeedDebuff},
        {"speeddebuff", RuleId::SpeedDebuff},
        {"dangerous terrain debuff", RuleId::DangerousTerrainDebuff},
        {"dangerousterraindebuff", RuleId::DangerousTerrainDebuff},
        {"mind control", RuleId::MindControl},
        {"mindcontrol", RuleId::MindControl},
        {"difficult terrain debuff", RuleId::DifficultTerrainDebuff},
        {"difficultterraindebuff", RuleId::DifficultTerrainDebuff},
        {"casting debuff", RuleId::CastingDebuff},
        {"castingdebuff", RuleId::CastingDebuff},

        // === Category T: Defense/Growth Rules ===
        {"fortified growth", RuleId::FortifiedGrowth},
        {"fortifiedgrowth", RuleId::FortifiedGrowth},
        {"grounded stealth", RuleId::GroundedStealth},
        {"groundedstealth", RuleId::GroundedStealth},
        {"protection feat", RuleId::ProtectionFeat},
        {"protectionfeat", RuleId::ProtectionFeat},

        // === Category U: Deployment Rules ===
        {"infiltrate", RuleId::Infiltrate},
        {"spawn", RuleId::Spawn},
        {"re-deployment", RuleId::ReDeployment},
        {"redeployment", RuleId::ReDeployment},
        {"rapid ambush", RuleId::RapidAmbush},
        {"rapidambush", RuleId::RapidAmbush},
        {"ambush beacon", RuleId::AmbushBeacon},
        {"ambushbeacon", RuleId::AmbushBeacon},
        {"ambush re-deployment", RuleId::AmbushReDeployment},
        {"ambushredeployment", RuleId::AmbushReDeployment},
        {"repel ambushers", RuleId::RepelAmbushers},
        {"repelambushers", RuleId::RepelAmbushers},
        {"reinforcement", RuleId::Reinforcement},
        {"fanatic", RuleId::Fanatic},
        {"split", RuleId::Split},

        // === Category V: Movement Rules ===
        {"teleport", RuleId::Teleport},
        {"wolfborn", RuleId::Wolfborn},
        {"hit & run shooter", RuleId::HitAndRunShooter},
        {"hitandrunshooter", RuleId::HitAndRunShooter},
        {"hit and run shooter", RuleId::HitAndRunShooter},
        {"rapid blink", RuleId::RapidBlink},
        {"rapidblink", RuleId::RapidBlink},
        {"bounding", RuleId::Bounding},

        // === Category W: Faction/Morale/Misc ===
        {"devout boost", RuleId::DevoutBoost},
        {"devoutboost", RuleId::DevoutBoost},
        {"mend", RuleId::Mend},
        {"hive bond", RuleId::HiveBond},
